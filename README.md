...
## Storage and Media Processing
  ...
  * [cloudimage.io](https://www.cloudimage.io/) — Full image optimization and CDN service with Asset library and 1500+ Points of Presence around the world. A variety of image resizing, compression, and watermarking functions. Open source plugins for responsive images, 360 image making and image editing. 30-days free trial for Essential plan with 100 GB of CDN traffic and 25 GB sloud storage for nearly unlimited transformations and image cache (fair usage policy).
